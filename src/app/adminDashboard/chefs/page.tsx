...
export default function ChefsPage() {
  ...
  useEffect(() => {
    setPending(JSON.parse(localStorage.getItem("pendingChefs") || "[]"));
    setAccounts(JSON.parse(localStorage.getItem("chefAccounts") || "[]"));
  }, []);

  function savePending(next: Pending[]) {
    localStorage.setItem("pendingChefs", JSON.stringify(next));
    setPending(next);
  }
  
  function saveAccounts(next: Account[]) {
    localStorage.setItem("chefAccounts", JSON.stringify(next));
    setAccounts(next);
  }
