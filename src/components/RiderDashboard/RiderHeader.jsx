...
export function RiderHeader({ onMenuClick }) {
  ...
  const [notifications, setNotifications] = useState(3); // dummy – replace later
      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-green rounded-full flex items-center justify-center text-white font-semibold">
              {initial}
            </div>
            <span className="hidden lg:block text-sm font-medium">{riderName}</span>
          </div>
        </div>
      </div>
    </header>
