...
const PharmacyCard = ({ id, name, image, location, specialty, rating }: PharmacyProps) => {
  return (
    <motion.div 
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="text-green font-medium text-sm mb-3">{specialty}</p>
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          {specialty.split(",").slice(0, 3).map((item, index) => (
            <span 
              key={index}
